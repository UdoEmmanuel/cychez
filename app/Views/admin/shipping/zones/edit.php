...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <form action="<?= base_url('admin/shipping-zones/update/' . $zone['id']) ?>" method="POST">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="base_fee"
                            value="<?= old('base_fee', $zone['base_fee']) ?>"
                            step="0.01"
                            min="0"
                            required
                        >
                    ...
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            class="form-control"
                            name="priority"
                            value="<?= old('priority', $zone['priority']) ?>"
                            min="1"
                            required
                        >
                        <small class="text-muted">
                            Lower number = Higher priority (1 = checked first)
                        </small>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?= base_url('admin/shipping-zones') ?>" class="btn btn-secondary">
                            Cancel
                        </a>
                    </div>
                </form>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="small">
                    ...
                    <li>You can edit zone locations separately</li>
                </ul>
            </div>
        </div>
    </div>
